    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.inputContainer} onPress={() => {}}>
       ...
       <View style={styles.callButtonRow}>
        ...
        <TouchableOpacity style={styles.callButton} onPress={() => {/* Trigger call to 1122 */}}>
          <View style={styles.innerBorder}>
            <Icon name="phone" size={20} color="#800080" style={styles.iconStyle} />
            <View style={styles.textContainer}>
              <Text style={styles.callButtonNumber}>1122</Text>
              <Text style={styles.callButtonLabel}>Call Rescue</Text>
            </View>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.callButtonRow}>
        <TouchableOpacity style={styles.callButton} onPress={() => {/* Trigger call to 130 */}}>
          <View style={styles.innerBorder}>
            <Icon name="phone" size={20} color="#800080" style={styles.iconStyle} />
            <View style={styles.textContainer}>
        ...
        <TouchableOpacity style={styles.callButton} onPress={() => {/* Trigger call to 1991 */}}>
          <View style={styles.innerBorder}>
            <Icon name="phone" size={20} color="#800080" style={styles.iconStyle} />
            <View style={styles.textContainer}>
